    ...
    init {
        if(socket == null || !socket!!.connected()){
            ...
            if(rtcConfiguration == null) {
                ...
                val sessionId: String = SharedStore.dependencies!!.uuidGenerator.generateRandomUUID()
                ...
                idsToContact.forEach { id ->
                    SharedStore.dependencies!!.eventLoop.postEvent(OnInitiatorNodeReadyToCreateOffer(id))
                }
