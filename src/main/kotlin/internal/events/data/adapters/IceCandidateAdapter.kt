...
internal class IceCandidateAdapter {
     ...
     *
     * @return An Optional containing the RTCIceCandidate if conversion is successful, otherwise empty.
     */
    fun toConcrete(): Optional<RTCIceCandidate> {
        ...
        return if(serverUrl == null){
            Optional.of(RTCIceCandidate(sdpMid, sdpMLineIndex!!, sdp))
        } else {
            Optional.of(RTCIceCandidate(sdpMid, sdpMLineIndex!!, sdp, serverUrl))
        }
    }
